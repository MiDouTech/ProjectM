<template>
  <div class="mido-page">
    ...
    <el-alert class="apv__note" type="info" :closable="false" show-icon
      title="待我审批列表（按当前登录人解析待办）将在审批待办接口就绪后接入"
      description="当前可通过审批实例 ID 打开任一立项申请，查看流程进度并审批（通过/驳回）。提交立项后会返回实例 ID。" />
